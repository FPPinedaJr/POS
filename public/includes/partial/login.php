<div
    ...
    <form action="./includes/login.php" method="POST" class="w-full flex flex-col shrink-0">
        ...
        <button type="submit" style="background-color: #60C5C5;"
            class="w-full hover:opacity-90 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg focus:ring-4 focus:ring-[#60C5C5]/30 focus:outline-none cursor-pointer">
            Log In
        </button>
    ...
    <p class="mt-5 shrink-0 text-sm text-slate-600 font-medium">
        Don't have an account? <a href="signup.php"
            class="text-[#60C5C5] hover:text-[#4da0a0] font-bold transition-colors">Sign up</a>
    </p>
