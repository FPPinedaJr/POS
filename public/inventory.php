                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-4">
                                <div class="flex-1 relative w-full">
                                    ...
                                    <input type="search" name="q" id="q" value="<?php echo htmlspecialchars($q); ?>"
                                        class="block w-full h-12 rounded-2xl bg-white/70 border border-white/60 pl-12 pr-4 shadow-sm shadow-slate-200 focus:outline-none focus:ring-4 focus:ring-indigo-500/15 focus:border-indigo-200 focus:bg-white text-sm transition-all font-medium text-slate-800 placeholder-slate-400/80"
